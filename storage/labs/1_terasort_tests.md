...
```
* adjusd `dfs.datanode.max.locked.memory` using CM, see https://github.com/michalklempa/SEBC/blob/master/storage/labs/dfs.datanode.max.locked.memory.png. Restarted datanodes.
